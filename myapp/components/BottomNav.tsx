...
const navItems = [
  ...
  { id: 'compare', href: '/compare', icon: CompareIcon, label: 'compare' },
  { id: 'log', href: '/log', icon: LogIcon, label: 'log' },
  { id: 'calendar', href: '/calendar', icon: CalendarIcon, label: 'calendar' },
